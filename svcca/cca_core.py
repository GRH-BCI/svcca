...
def get_cca_similarity(acts1, acts2, epsilon=1e-10, threshold=0.98,
    ...
    if compute_coefs:
        ...
        linalg.place(return_dict['full_coef_x'], x_mask, return_dict['coef_x'])
        return_dict['full_invsqrt_xx'] = linalg.zeros((numx, numx))
        linalg.place(return_dict['full_invsqrt_xx'], x_mask, return_dict['invsqrt_xx'])

        return_dict['coef_y']          = v
        return_dict['invsqrt_yy']      = invsqrt_yy
        return_dict['full_coef_y']     = linalg.zeros((numy, numy))
        linalg.place(return_dict['full_coef_y'], y_mask, return_dict['coef_y'])
        return_dict['full_invsqrt_yy'] = linalg.zeros((numy, numy))
        linalg.place(return_dict['full_invsqrt_yy'], y_mask, return_dict['invsqrt_yy'])
